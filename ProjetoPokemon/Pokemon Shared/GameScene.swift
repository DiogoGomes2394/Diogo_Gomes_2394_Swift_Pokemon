...
//  Pokemon Shared
//
//  Created by Diogo Gomes on 01/01/2022.
//
...
class GameScene: SKScene {
    ...
    class func newGameScene() -> GameScene {
        ...
        // Defina o modo de escala para ajustar a janela
...
#if os(iOS) || os(tvOS)
// Manipulação de eventos baseada em toque
extension GameScene {
...
// Manipulação de eventos baseada em mouse
extension GameScene {
